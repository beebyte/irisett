...
async def get_bindata(
    dbcon: DBConnection, object_type: str, object_id: int, key: str
) -> bytes:
...
async def set_bindata(
    dbcon: DBConnection, object_type: str, object_id: int, key: str, value: bytes
):
